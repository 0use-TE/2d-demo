...
public partial class TestHpui : Control
{
    ...
    // 注入订阅器
    [Inject] public ISubscriber<EnemySpotted> _spottedSub = default!;
    [Inject] public ISubscriber<EnemyGone> _goneSub = default!;
    [Inject] public ISubscriber<EnemyHealthChanged> _healthSub = default!;
